---
title: "Backend Engineering Quick Reference"
description: "> Concise, actionable patterns for AI coding assistants to generate better backend code."
generated: true
---

<!-- AUTO-GENERATED -->
<!-- Source: docs/backend-quick-reference.md -->

:::caution[Auto-generated]
This file is auto-generated from `docs/backend-quick-reference.md`. Do not edit directly.
:::
