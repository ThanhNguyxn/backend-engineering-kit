 ...
 */
function resolveAssetDir(assetName: string): string {
...
export const AI_ADAPTERS: Record<string, {
    name: string;
    folder: string;
    file: string;
    template: string;
...
export function copyAdapterFiles(
    adapters: string[],
    targetDir: string,
    dryRun: boolean
): { copied: string[]; missing: string[] } {
...
export function copyIndustryRules(
    targetDir: string,
    dryRun: boolean
): boolean {
