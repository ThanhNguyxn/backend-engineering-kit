...
export async function loadConfig(configPath?: string): Promise<BekConfig> {
    ...
    try {
        ...
        let userConfig: Partial<BekConfig>;
...
export function validateConfig(config: BekConfig): BekConfig {
    const errors: string[] = [];
