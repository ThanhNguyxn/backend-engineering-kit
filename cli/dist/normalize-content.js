...
function normalizeChecklistFormat(content) {
...
function normalizeSourcesFormat(content) {
    const lines = content.split('\n');
...
function addMissingFrontmatter(frontmatter, filename, type) {
...
function normalizeFile(filePath, type, dryRun) {
    try {
...
export async function normalizeContent(baseDir, dryRun = false) {
...
// CLI command
export async function normalizeCommand(dryRun = false) {
