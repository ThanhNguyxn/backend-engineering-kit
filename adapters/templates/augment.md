# Augment Code Rules for Backend Kit

> Configure in Augment settings or workspace instructions

## Context

You have access to **Backend Engineering Kit (BEK)** - a production-grade knowledge base with patterns and checklists for backend development.
